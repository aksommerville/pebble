 ...
 * Even when that's wrong, it's good for us to be wrong the same way, for consistency.
 */
 
int evdev_guess_pblbtnid(int type,int code) {
  switch (type) {
    case EV_ABS: switch (code) {
        case ABS_X: return PBL_BTN_LEFT|PBL_BTN_RIGHT;
        case ABS_Y: return PBL_BTN_UP|PBL_BTN_DOWN;
        case ABS_Z: return PBL_BTN_L2;
        case ABS_RX: return 0; // right stick horz
        case ABS_RY: return 0; // right stick vert
        case ABS_RZ: return PBL_BTN_R2;
        case ABS_HAT0X: return PBL_BTN_LEFT|PBL_BTN_RIGHT;
        case ABS_HAT0Y: return PBL_BTN_UP|PBL_BTN_DOWN;
        case ABS_HAT1X: return PBL_BTN_LEFT|PBL_BTN_RIGHT;
        case ABS_HAT1Y: return PBL_BTN_UP|PBL_BTN_DOWN;
        case ABS_HAT2X: return PBL_BTN_LEFT|PBL_BTN_RIGHT;
        case ABS_HAT2Y: return PBL_BTN_UP|PBL_BTN_DOWN;
        case ABS_HAT3X: return PBL_BTN_LEFT|PBL_BTN_RIGHT;
        case ABS_HAT3Y: return PBL_BTN_UP|PBL_BTN_DOWN;
      } break;
    case EV_KEY: switch (code) {
        case BTN_SOUTH: return PBL_BTN_SOUTH;
        case BTN_EAST: return PBL_BTN_EAST;
        case BTN_NORTH: return PBL_BTN_NORTH;
        case BTN_WEST: return PBL_BTN_WEST;
        case BTN_TL: return PBL_BTN_L1;
        case BTN_TR: return PBL_BTN_R1;
        case BTN_TL2: return PBL_BTN_L2;
        case BTN_TR2: return PBL_BTN_R2;
